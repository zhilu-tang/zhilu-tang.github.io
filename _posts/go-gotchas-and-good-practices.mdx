...
These are some of the common mistakes we make in Go and also good practices that I felt worth sharing. Also check out my previous article on [Advanced Go](https://zhilu-tang.github.io/blog/advanced-golang-memory-model-concurrency) about memory model and concurrency in Go.
